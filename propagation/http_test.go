...
func TestHTTPFormat(t *testing.T) {
	format := &HTTPFormat{}
	traceID := [16]byte{66, 179, 103, 245, 105, 105, 242, 156, 0, 0, 0, 0, 0, 0, 0, 0}
	...
	tests := []struct {
		...
		{
			incoming: "42b367f56969f29c:68b9b859f3b91333:0:1",
			wantSpanContext: trace.SpanContext{
				TraceID:      traceID,
				SpanID:       spanID1,
				TraceOptions: 1,
		...
		{
			incoming: "42b367f56969f29c:43d3e654b427b68b:0:0",
			wantSpanContext: trace.SpanContext{
				TraceID:      traceID,
				SpanID:       spanID2,
				TraceOptions: 0,
